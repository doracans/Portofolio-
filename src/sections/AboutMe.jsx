  ...
  return (
   <section id="about" className="container mx-auto px-8 py-16">
    ...
    <div className='flex flex-col lg:flex-row gap-16 items-start justify-between'>
      <div className='w-[300px] md:w-[370px] h-[350px] mf:h-[428px] bg-purple-200/50 rounded-3xl mx-auto lg:mx-0 relative flex-shrink-0'>
      ...
      <div className='flex-1'>
        ...
        <div className='flex gap-4 mt-6'>
         {ABOUT_ME.socialLinks.map((item) => (
           ...
           target="_blank" rel="noopener noreferrer" className='cursor-pointer group'>
